...
const Spotify = {
  ...
  search(term, genre, limit, year, offset) {
    const data = {
      method: 'GET',
      headers: {
    ...
    const url = `https://cors-anywhere.herokuapp.com/https://api.spotify.com/v1/search?type=track&offset=${offset}&limit=${limit}&q=${term} year:${year} genre:"${genre}"`;
